...
Assignment 7 - Problem B

Name : Krishna Kant Verma(2211cs19)
Name : Gourab Chatterji(2211cs08)
Name : Aditi Marathe(2211cs01)

Write a program in Prolog to represent the following knowledge and solve the answer to
the given questions.
a. Knowledge: On a river bank, there are 3 cannibals and 3 missionaries. Here is a
boat with 2 places for crossing the river. If on a bank, there remain more
cannibals than missionaries, then it is dangerous since the cannibals may eat them.
